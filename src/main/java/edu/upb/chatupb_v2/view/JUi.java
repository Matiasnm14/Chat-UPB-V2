...
//    }
    ...
    private void initComponents() {
        ...
        // --- NUEVO: CONSTRUCCIÓN DE LA BARRA DE MENSAJE FIJADO ---
        ...
        pinnedMessagePanel.setVisible(false); // Oculto por defecto
        ...
        // Unimos el Pin Panel (Arriba) con el Fondo del Chat (Centro)
        ...
        JButton btnSend = new JButton("Enviar 💣"); // Actualizado visualmente
        ...
        rightPanel.add(centerChatPanel, BorderLayout.CENTER); // <-- NUEVO: Ahora agregamos el centerChatPanel aquí
...
//        showMessage("\n--- ¡" + senderName + " te ha enviado un Zumbido! ---\n");
    ...
    public void applyTheme(String themeId) {
        ...
        switch (themeId) {
            case "1": // Por Defecto (Claro)
                changeTheme(basePath + "Atacama.png", // Sin imagen
                        new Color(220, 248, 198), Color.WHITE, // Burbujas: Verde / Blanco
                        Color.BLACK, Color.BLACK);             // Texto: Negro
                break;

            case "2": // Modo Oscuro
                changeTheme(basePath + "paisaje-digital-en-atardecer-5846.jpg", // Sin imagen, o usa basePath + "dark.jpg"
                        new Color(5, 70, 64), new Color(38, 45, 49), // Burbujas oscuras
                        Color.WHITE, Color.WHITE);                   // Texto blanco
                break;

            case "3": // Matrix (Hackers)
    ...
    public void changeTheme(String imagePath, Color myBubble, Color otherBubble, Color myText, Color otherText) {
        ...
        // 1. Cargar la imagen de fondo si existe usando getClass().getResource()
        if (imagePath != null && !imagePath.isEmpty()) {
            try {
                // Buscamos el recurso dentro del classpath
        ...
        // 2. Actualizar los colores en el Render
        ...
        // 3. Forzar a Java Swing a redibujar todo
